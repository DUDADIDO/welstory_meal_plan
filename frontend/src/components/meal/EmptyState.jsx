...
export default function EmptyState({ data, error, onRetry }) {
  ...
  return (
    <section className="mx-auto mb-24 max-w-2xl rounded-[2rem] bg-surface px-6 py-16 text-center shadow-[0_2px_24px_rgb(0_0_0/0.05)] ring-1 ring-[var(--theme-border)] sm:px-12">
